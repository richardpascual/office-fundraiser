...
prompt  APPLICATION 101 - office-fundraiser
--
-- Application Export:
--   Application:     101
--   Name:            office-fundraiser
--   Date and Time:   11:14 Friday July 6, 2012
--   Exported By:     ADMIN
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,4874405770086741));
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'RICHARD'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'office-fundraiser'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F101'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 5008509011464177 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 5008730570464177 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 5011205224464181 + wwv_flow_api.g_id_offset,
  p_error_template=> 5008102977464175 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20120706105942',
  ...
  p_cust_authentication_process=> '.'||to_char(5016113121464197 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 12,
  p_default_label_template => 5014715842464185 + wwv_flow_api.g_id_offset,
  p_default_report_template => 5014002262464184 + wwv_flow_api.g_id_offset,
  p_default_list_template => 5013117959464183 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 5015020532464185 + wwv_flow_api.g_id_offset,
  p_default_button_template => 5009219980464178 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 5010221679464180 + wwv_flow_api.g_id_offset,
  p_default_form_template => 5010319482464180 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 5011824022464181 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 5011205224464181 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>5011205224464181 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 5009819942464179 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 5010105604464179 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 5010800184464180 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss=> '20120706105942',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 5016312253464197 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_tab (
  p_id=> 5017725009464216 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_HOME',
  p_tab_text => 'Home',
  p_tab_step => 1,
  p_tab_also_current_for_pages => '2,3,4,5,6,7,8,9',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
...
wwv_flow_api.create_list_of_values (
  p_id       => 5018609040464243 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'Report Row Per Page',
  p_lov_query=> '.'||to_char(5018609040464243 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5018704019464245 + wwv_flow_api.g_id_offset,
  p_lov_id=>5018609040464243 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5018823201464246 + wwv_flow_api.g_id_offset,
  p_lov_id=>5018609040464243 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5018912291464246 + wwv_flow_api.g_id_offset,
  p_lov_id=>5018609040464243 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5019025355464246 + wwv_flow_api.g_id_offset,
  p_lov_id=>5018609040464243 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5019104240464246 + wwv_flow_api.g_id_offset,
  p_lov_id=>5018609040464243 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5019224551464246 + wwv_flow_api.g_id_offset,
  p_lov_id=>5018609040464243 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5019304727464246 + wwv_flow_api.g_id_offset,
  p_lov_id=>5018609040464243 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5019406525464246 + wwv_flow_api.g_id_offset,
  p_lov_id=>5018609040464243 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5019508412464246 + wwv_flow_api.g_id_offset,
  p_lov_id=>5018609040464243 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5019600370464247 + wwv_flow_api.g_id_offset,
  p_lov_id=>5018609040464243 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_plug (
  p_id=> 5018317206464222 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Navigation',
  p_region_name=>'',
  p_plug_template=> 5011122058464181+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
  p_plug_source_type=> 5017817474464218 + wwv_flow_api.g_id_offset,
  p_list_template_id=> 5012713255464183+ wwv_flow_api.g_id_offset,
  p_translate_title=> 'Y',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5018500193464241 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 5009819942464179+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(5017412080464213 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 5015020532464185+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page (
 ...
 ,p_tab_set => 'TS1'
 ,p_name => 'Fund People'
 ,p_step_title => 'Fund People'
 ,p_step_sub_title => 'Fund People'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20120706105657'
  );
null;
...
' from   "FUND_PEOPLE" '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 5019910121464248 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Donor List',
  p_region_name=>'',
  p_plug_template=> 5010800184464180+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
wwv_flow_api.create_worksheet(
  p_id=> 5020005668464248+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_region_id=> 5019910121464248+wwv_flow_api.g_id_offset,
  p_name=> 'FUND_PEOPLE',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
wwv_flow_api.create_worksheet_column(
  p_id => 5020113696464261+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5020005668464248+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PERSON_ID',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Person Id',
  p_report_label           =>'Person Id',
  p_sync_form_label        =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5020205102464266+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5020005668464248+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ANONYMOUS_IND',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Anonymous Ind',
  p_report_label           =>'Anonymous Ind',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5020308437464266+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5020005668464248+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ALIAS_IND',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'Alias Ind',
  p_report_label           =>'Alias Ind',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5020424523464266+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5020005668464248+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ALIAS_NAME',
  p_display_order          =>4,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'D',
  p_column_label           =>'Alias Name',
  p_report_label           =>'Alias Name',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5020524595464266+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5020005668464248+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5020614437464266+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5020005668464248+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5020723222464266+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5020005668464248+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5020805208464266+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5020005668464248+wwv_flow_api.g_id_offset,
...
begin
rc1:=rc1||'PERSON_ID:ANONYMOUS_IND:ALIAS_IND:ALIAS_NAME:FIRST_NAME:LAST_NAME:PHONE_NUMBER:EMAIL_ADDRESS';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5034932738485717+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5020005668464248+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5021119878464268 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5023817397464325 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 10,
  p_button_plug_id => 5019910121464248+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image   => 'template:'||to_char(5009219980464178+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Create',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=101:3:&SESSION.::&DEBUG.:3',
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20120706105627'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5021421808464306 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_plug_name=> 'Edit Donor Information',
  p_region_name=>'',
  p_plug_template=> 5010319482464180+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5024003362464326 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5021516944464309 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
  p_button_sequence=> 10,
  p_button_plug_id => 5021421808464306+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5021720276464309 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
...
wwv_flow_api.create_page_button(
  p_id             => 5021818611464309 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
...
wwv_flow_api.create_page_button(
  p_id             => 5021601230464309 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
...
wwv_flow_api.create_page_branch(
  p_id=>5022023025464318 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
...
wwv_flow_api.create_page_item(
  p_id=>5022126674464319 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_name=>'P3_PERSON_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 1,
  p_item_plug_id => 5021421808464306+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 5014715842464185+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'Y',
  p_item_comment => '');
...
wwv_flow_api.create_page_item(
  p_id=>5022212422464319 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_name=>'P3_ANONYMOUS_IND',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5021421808464306+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Anonymous Ind',
  p_source=>'ANONYMOUS_IND',
  p_source_type=> 'DB_COLUMN',
...
wwv_flow_api.create_page_item(
  p_id=>5022429095464321 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_name=>'P3_ALIAS_IND',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>5022612885464321 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_name=>'P3_ALIAS_NAME',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 3,
...
wwv_flow_api.create_page_item(
  p_id=>5022805854464321 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
...
wwv_flow_api.create_page_item(
  p_id=>5023015123464321 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_name=>'P3_LAST_NAME',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>5023222613464321 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
...
wwv_flow_api.create_page_item(
  p_id=>5023407638464321 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:FUND_PEOPLE:P3_PERSON_ID:PERSON_ID';

wwv_flow_api.create_page_process(
  p_id     => 5023629843464322 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from FUND_PEOPLE',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:FUND_PEOPLE:P3_PERSON_ID:PERSON_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5023731659464323 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of FUND_PEOPLE',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table FUND_PEOPLE.',
...
wwv_flow_api.create_page (
 ...
 ,p_tab_set => 'TS1'
 ,p_name => 'Fundraiser'
 ,p_step_title => 'Fundraiser'
 ,p_step_sub_title => 'Fundraiser'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_upd_yyyymmddhh24miss => '20120706103907'
  );
null;
...
'"START_DATE",'||chr(10)||
'"END_DATE"'||chr(10)||
' from   "FUNDRAISER" '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 5024322049464327 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'FUNDRAISER',
  p_region_name=>'',
  p_plug_template=> 5010800184464180+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_worksheet(
  p_id=> 5024432017464327+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_region_id=> 5024322049464327+wwv_flow_api.g_id_offset,
  p_name=> 'FUNDRAISER',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:5:#APP_SESSION#::::P5_FUND_ID:#FUND_ID#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif" alt="Edit" />',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5024521790464327+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5024432017464327+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'FUND_ID',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Fund Id',
  p_report_label           =>'Fund Id',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5024610303464327+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5024432017464327+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'FUND_TITLE',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Fund Title',
  p_report_label           =>'Fund Title',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5024716899464327+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5024432017464327+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5024828329464327+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5024432017464327+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'FUND_ID:FUND_TITLE:START_DATE:END_DATE';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5034621525473058+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5024432017464327+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5025108787464328 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5026915638464329 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 10,
  p_button_plug_id => 5024322049464327+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image   => 'template:'||to_char(5009219980464178+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Create',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=101:5:&SESSION.::&DEBUG.:5',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5025421112464328 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Edit FUNDRAISER',
  p_region_name=>'',
  p_plug_template=> 5010319482464180+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5027118974464329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5025523155464328 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 10,
  p_button_plug_id => 5025421112464328+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(5009219980464178+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Cancel',
  p_button_position=> 'REGION_TEMPLATE_CLOSE',
...
wwv_flow_api.create_page_button(
  p_id             => 5025723489464328 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 30,
  p_button_plug_id => 5025421112464328+wwv_flow_api.g_id_offset,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P5_FUND_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5025823858464328 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 40,
  p_button_plug_id => 5025421112464328+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5025626970464328 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 20,
  p_button_plug_id => 5025421112464328+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5025914615464328 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5026031829464328 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_FUND_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5025421112464328+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Fund Id',
  p_source=>'FUND_ID',
  p_source_type=> 'DB_COLUMN',
...
wwv_flow_api.create_page_item(
  p_id=>5026103798464328 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_FUND_TITLE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
...
wwv_flow_api.create_page_item(
  p_id=>5026332661464329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
...
wwv_flow_api.create_page_item(
  p_id=>5026514245464329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_END_DATE',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:FUNDRAISER:P5_FUND_ID:FUND_ID';

wwv_flow_api.create_page_process(
  p_id     => 5026712143464329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from FUNDRAISER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:FUNDRAISER:P5_FUND_ID:FUND_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5026808067464329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of FUNDRAISER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table FUNDRAISER.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page (
 ...
 ,p_tab_set => 'TS1'
 ,p_name => 'Fund Pledge'
 ,p_step_title => 'Fund Pledge'
 ,p_step_sub_title => 'Fund Pledge'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
...
'"FUND_ID",'||chr(10)||
'"PAID_IND"'||chr(10)||
' from   "FUND_PLEDGE" '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 5027401316464330 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'FUND_PLEDGE',
  p_region_name=>'',
  p_plug_template=> 5010800184464180+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_worksheet(
  p_id=> 5027528449464330+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_region_id=> 5027401316464330+wwv_flow_api.g_id_offset,
  p_name=> 'FUND_PLEDGE',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:7:#APP_SESSION#::::P7_PLEDGE_ID:#PLEDGE_ID#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif" alt="Edit" />',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5027603403464330+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5027528449464330+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PLEDGE_ID',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Pledge Id',
  p_report_label           =>'Pledge Id',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5027704347464330+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5027528449464330+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PLEDGE_DATE',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Pledge Date',
  p_report_label           =>'Pledge Date',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5027807501464330+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5027528449464330+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5027901094464330+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5027528449464330+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PERSON_ID',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5028001458464330+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5027528449464330+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'FUND_ID',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5028100512464330+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5027528449464330+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PAID_IND',
  p_display_order          =>6,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'F',
  p_column_label           =>'Paid Ind',
  p_report_label           =>'Paid Ind',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'PLEDGE_ID:PLEDGE_DATE:AMOUNT:PERSON_ID:FUND_ID:PAID_IND';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5035205904515798+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5027528449464330+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5028415633464333 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5030615874464342 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 10,
  p_button_plug_id => 5027401316464330+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image   => 'template:'||to_char(5009219980464178+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Create',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=101:7:&SESSION.::&DEBUG.:7',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5028720298464333 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_plug_name=> 'Edit FUND_PLEDGE',
  p_region_name=>'',
  p_plug_template=> 5010319482464180+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5030809475464342 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5028812409464334 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 10,
  p_button_plug_id => 5028720298464333+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(5009219980464178+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Cancel',
  p_button_position=> 'REGION_TEMPLATE_CLOSE',
...
wwv_flow_api.create_page_button(
  p_id             => 5029032717464334 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 30,
  p_button_plug_id => 5028720298464333+wwv_flow_api.g_id_offset,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P7_PLEDGE_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5029123171464334 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 40,
  p_button_plug_id => 5028720298464333+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5028911654464334 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 20,
  p_button_plug_id => 5028720298464333+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5029229135464334 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5029328857464334 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_PLEDGE_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5028720298464333+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Pledge Id',
  p_source=>'PLEDGE_ID',
  p_source_type=> 'DB_COLUMN',
...
wwv_flow_api.create_page_item(
  p_id=>5029423999464334 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_PLEDGE_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5028720298464333+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Pledge Date',
  p_source=>'PLEDGE_DATE',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DATE_PICKER',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
wwv_flow_api.create_page_item(
  p_id=>5029615493464341 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_AMOUNT',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>5029825624464341 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_PERSON_ID',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>5030030101464341 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_FUND_ID',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>5030223298464341 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_PAID_IND',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:FUND_PLEDGE:P7_PLEDGE_ID:PLEDGE_ID';

wwv_flow_api.create_page_process(
  p_id     => 5030412990464341 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from FUND_PLEDGE',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:FUND_PLEDGE:P7_PLEDGE_ID:PLEDGE_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5030519606464342 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of FUND_PLEDGE',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table FUND_PLEDGE.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page (
 ...
 ,p_tab_set => 'TS1'
 ,p_name => 'Fund Payment'
 ,p_step_title => 'Fund Payment'
 ,p_step_sub_title => 'Fund Payment'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
...
'"PAYMENT_DATE",'||chr(10)||
'"PLEDGE_ID",'||chr(10)||
'"AMOUNT_COLLECTED"'||chr(10)||
' from   "FUND_PAYMENT" '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 5031120114464342 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_plug_name=> 'FUND_PAYMENT',
  p_region_name=>'',
  p_plug_template=> 5010800184464180+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_worksheet(
  p_id=> 5031200609464342+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_region_id=> 5031120114464342+wwv_flow_api.g_id_offset,
  p_name=> 'FUND_PAYMENT',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:9:#APP_SESSION#::::P9_PAYMENT_ID:#PAYMENT_ID#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif" alt="Edit" />',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5031301031464343+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 5031200609464342+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PAYMENT_ID',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Payment Id',
  p_report_label           =>'Payment Id',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5031423561464343+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 5031200609464342+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5031525249464343+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 5031200609464342+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PLEDGE_ID',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5031619151464343+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 5031200609464342+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'AMOUNT_COLLECTED',
  p_display_order          =>4,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'D',
  p_column_label           =>'Amount Collected',
  p_report_label           =>'Amount Collected',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'PAYMENT_ID:PAYMENT_DATE:PLEDGE_ID:AMOUNT_COLLECTED';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5035508375544906+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 5031200609464342+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5031905680464343 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5033725627464345 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 10,
  p_button_plug_id => 5031120114464342+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image   => 'template:'||to_char(5009219980464178+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Create',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=101:9:&SESSION.::&DEBUG.:9',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5032213276464344 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_plug_name=> 'Edit FUND_PAYMENT',
  p_region_name=>'',
  p_plug_template=> 5010319482464180+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5033906930464345 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5032330616464344 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 10,
  p_button_plug_id => 5032213276464344+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(5009219980464178+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Cancel',
  p_button_position=> 'REGION_TEMPLATE_CLOSE',
...
wwv_flow_api.create_page_button(
  p_id             => 5032504329464344 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 30,
  p_button_plug_id => 5032213276464344+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5032612855464344 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 40,
  p_button_plug_id => 5032213276464344+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5032419268464344 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 20,
  p_button_plug_id => 5032213276464344+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5032711923464344 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5032820340464344 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5032213276464344+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Payment Id',
  p_source=>'PAYMENT_ID',
  p_source_type=> 'DB_COLUMN',
...
wwv_flow_api.create_page_item(
  p_id=>5032911498464344 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
...
wwv_flow_api.create_page_item(
  p_id=>5033103526464344 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_PLEDGE_ID',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>5033329381464344 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_AMOUNT_COLLECTED',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 3,
  p_item_plug_id => 5032213276464344+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Amount Collected',
  p_source=>'AMOUNT_COLLECTED',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_NUMBER_FIELD',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:FUND_PAYMENT:P9_PAYMENT_ID:PAYMENT_ID';

wwv_flow_api.create_page_process(
  p_id     => 5033522160464344 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from FUND_PAYMENT',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:FUND_PAYMENT:P9_PAYMENT_ID:PAYMENT_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5033623168464345 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of FUND_PAYMENT',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table FUND_PAYMENT.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 5007717683464173 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_last_upd_yyyymmddhh24miss => '20120706103906'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5016632248464203 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5016709634464208 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5016632248464203+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5016802541464211 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5016918685464211 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(5009219980464178 + wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_process(
  p_id     => 5017100496464212 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 5017030178464212 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 5017309975464213 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 5017224628464212 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_list (
  p_id=> 5017817474464218 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
  p_display_row_template_id=> 5013117959464183 + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_list_item (
  p_id=> 5017922682464219 + wwv_flow_api.g_id_offset,
  p_list_id=> 5017817474464218 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>10,
  p_list_item_link_text=> 'Fund People',
...
wwv_flow_api.create_list_item (
  p_id=> 5018024378464221 + wwv_flow_api.g_id_offset,
  p_list_id=> 5017817474464218 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>20,
  p_list_item_link_text=> 'Fundraiser',
...
wwv_flow_api.create_list_item (
  p_id=> 5018129159464221 + wwv_flow_api.g_id_offset,
  p_list_id=> 5017817474464218 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>30,
  p_list_item_link_text=> 'Fund Payment',
  p_list_item_link_target=> 'f?p=&FLOW_ID.:8:&SESSION.::&DEBUG.:',
  p_list_countclicks_y_n=> 'N',
  p_list_text_01=> '',
  p_list_item_current_type=> 'COLON_DELIMITED_PAGE_LIST',
...
wwv_flow_api.create_list_item (
  p_id=> 5018221994464222 + wwv_flow_api.g_id_offset,
  p_list_id=> 5017817474464218 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>40,
  p_list_item_link_text=> 'Fund Pledge',
  p_list_item_link_target=> 'f?p=&FLOW_ID.:6:&SESSION.::&DEBUG.:',
  p_list_countclicks_y_n=> 'N',
  p_list_text_01=> '',
  p_list_item_current_type=> 'COLON_DELIMITED_PAGE_LIST',
...
wwv_flow_api.create_list (
  p_id=> 5020905229464267 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list (
  p_id=> 5024912460464327 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list (
  p_id=> 5028200600464331 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list (
  p_id=> 5031718442464343 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_menu (
  p_id=> 5017412080464213 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>5018425513464222 + wwv_flow_api.g_id_offset,
  p_menu_id=>5017412080464213 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
wwv_flow_api.create_menu_option (
  p_id=>5021028156464267 + wwv_flow_api.g_id_offset,
  p_menu_id=>5017412080464213 + wwv_flow_api.g_id_offset,
  p_parent_id=>5018425513464222 + wwv_flow_api.g_id_offset,
  p_option_sequence=>20,
  p_short_name=>'Fund People',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5023914741464326 + wwv_flow_api.g_id_offset,
  p_menu_id=>5017412080464213 + wwv_flow_api.g_id_offset,
  p_parent_id=>5021028156464267 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_menu_option (
  p_id=>5025015054464327 + wwv_flow_api.g_id_offset,
  p_menu_id=>5017412080464213 + wwv_flow_api.g_id_offset,
  p_parent_id=>5018425513464222 + wwv_flow_api.g_id_offset,
  p_option_sequence=>40,
  p_short_name=>'Fundraiser',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5027004886464329 + wwv_flow_api.g_id_offset,
  p_menu_id=>5017412080464213 + wwv_flow_api.g_id_offset,
  p_parent_id=>5025015054464327 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_menu_option (
  p_id=>5028321560464333 + wwv_flow_api.g_id_offset,
  p_menu_id=>5017412080464213 + wwv_flow_api.g_id_offset,
  p_parent_id=>5018425513464222 + wwv_flow_api.g_id_offset,
  p_option_sequence=>60,
  p_short_name=>'Fund Pledge',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5030722975464342 + wwv_flow_api.g_id_offset,
  p_menu_id=>5017412080464213 + wwv_flow_api.g_id_offset,
  p_parent_id=>5028321560464333 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_menu_option (
  p_id=>5031829853464343 + wwv_flow_api.g_id_offset,
  p_menu_id=>5017412080464213 + wwv_flow_api.g_id_offset,
  p_parent_id=>5018425513464222 + wwv_flow_api.g_id_offset,
  p_option_sequence=>80,
  p_short_name=>'Fund Payment',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5033818610464345 + wwv_flow_api.g_id_offset,
  p_menu_id=>5017412080464213 + wwv_flow_api.g_id_offset,
  p_parent_id=>5031829853464343 + wwv_flow_api.g_id_offset,
...
prompt  ......Page template 5007717683464173
...
wwv_flow_api.create_template(
  p_id=> 5007717683464173 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 5007824959464175
...
wwv_flow_api.create_template(
  p_id=> 5007824959464175 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5007916390464175
...
wwv_flow_api.create_template(
  p_id=> 5007916390464175 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5008027052464175
...
wwv_flow_api.create_template(
  p_id=> 5008027052464175 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5008102977464175
...
wwv_flow_api.create_template(
  p_id=> 5008102977464175 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5008219931464176
...
wwv_flow_api.create_template(
  p_id=> 5008219931464176 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5008301812464177
...
wwv_flow_api.create_template(
  p_id=> 5008301812464177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5008415223464177
...
wwv_flow_api.create_template(
  p_id=> 5008415223464177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5008509011464177
...
wwv_flow_api.create_template(
  p_id=> 5008509011464177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5008603225464177
...
c1:=c1||'#IMAGE_PREFIX#themes/theme_12/css/theme_4_0.css" type="text/css" />'||chr(10)||
'</head>'||chr(10)||
...
wwv_flow_api.create_template(
  p_id=> 5008603225464177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 5008730570464177
...
wwv_flow_api.create_template(
  p_id=> 5008730570464177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5008813260464177
...
wwv_flow_api.create_template(
  p_id=> 5008813260464177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5008917167464177
...
wwv_flow_api.create_template(
  p_id=> 5008917167464177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5009013378464178
...
wwv_flow_api.create_template(
  p_id=> 5009013378464178 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5009114151464178
...
wwv_flow_api.create_template(
  p_id=> 5009114151464178 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 5009219980464178
declare
...
wwv_flow_api.create_button_templates (
  p_id=>5009219980464178 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5009303056464178
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5009303056464178 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5009428976464178
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5009428976464178 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5009505712464178
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5009505712464178 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 5009623472464179
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5009623472464179 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5009727258464179
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5009727258464179 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5009819942464179
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5009819942464179 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5009904259464179
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5009904259464179 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5010019902464179
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5010019902464179 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-blank" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top">'||chr(10)||
...
prompt  ......region template 5010105604464179
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5010105604464179 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5010221679464180
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5010221679464180 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 5010319482464180
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5010319482464180 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5010419852464180
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5010419852464180 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="hide-show-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="hide-show-top">'||chr(10)||
'    <div class="hide-show-title"><a href="javascript:hideShow(''region#REGION_SEQUENCE_ID#'',''shIMG#REGION_SEQUENCE_ID#'',''#IMAGE_PREFIX#themes/theme_12/images/right_arrow.png'',''#IMAGE_PREFIX#themes/theme_12/images/down_arrow.png'');" class="t1HideandShowRegionLink"><img src="#IMAGE_PREFIX#themes/t'||
'heme_12/images/right_arrow.png" '||chr(10)||
...
prompt  ......region template 5010530432464180
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5010530432464180 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5010618042464180
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5010618042464180 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5010731708464180
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5010731708464180 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5010800184464180
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5010800184464180 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 5010900719464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5010900719464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5011025333464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5011025333464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5011122058464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5011122058464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-alt-top"><div class="rc-alt-top-r">'||chr(10)||
...
prompt  ......region template 5011205224464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5011205224464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5011322307464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5011322307464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5011432233464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5011432233464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-alt-top"><div class="rc-alt-top-r">'||chr(10)||
...
prompt  ......region template 5011502152464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5011502152464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5011627583464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5011627583464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5011708467464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5011708467464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-blank" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top">'||chr(10)||
...
prompt  ......region template 5011824022464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5011824022464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5011921867464181
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5011921867464181 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-wizard">'||chr(10)||
...
prompt  ......list template 5012003488464181
...
wwv_flow_api.create_list_template (
  p_id=>5012003488464181 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 5012107558464182
...
wwv_flow_api.create_list_template (
  p_id=>5012107558464182 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5012208143464182
...
wwv_flow_api.create_list_template (
  p_id=>5012208143464182 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5012318946464182
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5012318946464182 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5012411686464182
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5012411686464182 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5012515674464182
...
wwv_flow_api.create_list_template (
  p_id=>5012515674464182 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5012607320464183
...
wwv_flow_api.create_list_template (
  p_id=>5012607320464183 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5012713255464183
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5012713255464183 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5012827748464183
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5012827748464183 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5012914644464183
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5012914644464183 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5013002813464183
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5013002813464183 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5013117959464183
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5013117959464183 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5013210969464183
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5013210969464183 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5013309069464183
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5013309069464183 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5013423413464183
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5013423413464183 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 5013506576464183
...
wwv_flow_api.create_row_template (
  p_id=> 5013506576464183 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5013603383464184
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5013603383464184 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5013716315464184
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5013716315464184 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5013802296464184
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5013802296464184 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5013929082464184
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5013929082464184 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5014002262464184
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5014002262464184 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5014112541464185
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5014112541464185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5014223326464185
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5014223326464185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5014329593464185
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5014329593464185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5014406515464185
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5014406515464185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5014518059464185
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5014518059464185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5014621881464185
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5014621881464185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5014715842464185
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5014715842464185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5014831149464185
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5014831149464185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5014930173464185
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5014930173464185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5015020532464185
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5015020532464185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5015101916464187
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5015101916464187 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 5015808910464189
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 5015808910464189 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5015231425464187
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5015231425464187 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5015430188464188
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5015430188464188 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5015622405464188
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5015622405464188 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 5015906740464189
begin
wwv_flow_api.create_theme (
  p_id =>5015906740464189 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 12,
  p_theme_name=>'Slate',
  p_default_page_template=>5008509011464177 + wwv_flow_api.g_id_offset,
  ...
  p_login_template=>5007717683464173 + wwv_flow_api.g_id_offset,
  p_default_button_template=>5009219980464178 + wwv_flow_api.g_id_offset,
  p_default_region_template=>5011205224464181 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>5010221679464180 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>5010319482464180 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>5014715842464185 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>5015020532464185 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>5015231425464187 + wwv_flow_api.g_id_offset,
  p_default_list_template=>5013117959464183 + wwv_flow_api.g_id_offset,
  p_default_option_label=>5014715842464185 + wwv_flow_api.g_id_offset,
  p_default_required_label=>5014930173464185 + wwv_flow_api.g_id_offset);
end;
/
...
wwv_flow_api.create_shortcut (
 p_id=> 5021910969464314 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5016007843464196
...
wwv_flow_api.create_auth_setup (
  p_id=> 5016007843464196 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5016113121464197
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5016113121464197 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'DATABASE',
...
prompt  ......scheme 5016224819464197
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5016224819464197 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
